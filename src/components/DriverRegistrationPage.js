...
function Register() {
    ...
    const [roleID, setRoleID] = useState(3); // Default to Driver
    ...
    const handleRegister = async (e) => {
        ...
        try {
             axios.post('https://localhost:7016/api/Driver/SaveDriver', {
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.header}>Driver Registration Page</h2>
                ...
                <table style={styles.table}>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="DlNumber" value={dlNumber} onChange={(e) => setDlNumber(e.target.value)} /></td>
                        </tr>                       
                        <tr>
                            <td colSpan="2">
